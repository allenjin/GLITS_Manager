            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processes_stats = new ArrayList<ProcessStatus>(_list0.size);
                ProcessStatus _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new ProcessStatus();
                  _elem1.read(iprot);
                  struct.processes_stats.add(_elem1);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.mounted_avail_space = new HashMap<String,Long>(2*_map3.size);
                String _key4;
                long _val5;
                for (int _i6 = 0; _i6 < _map3.size; ++_i6)
                {
                  ...
                  _val5 = iprot.readI64();
                  struct.mounted_avail_space.put(_key4, _val5);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HeartbeatRequest struct) throws TException {
      ...
      if (struct.processes_stats != null) {
        oprot.writeFieldBegin(PROCESSES_STATS_FIELD_DESC);
        {
          ...
          for (ProcessStatus _iter7 : struct.processes_stats)
          {
            _iter7.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.mounted_avail_space != null) {
        oprot.writeFieldBegin(MOUNTED_AVAIL_SPACE_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Long> _iter8 : struct.mounted_avail_space.entrySet())
          {
      ...
      if (struct.isSetProcesses_stats()) {
        {
          ...
          for (ProcessStatus _iter9 : struct.processes_stats)
          {
            _iter9.write(oprot);
          }
        }
      ...
      if (struct.isSetMounted_avail_space()) {
        {
          ...
          for (Map.Entry<String, Long> _iter10 : struct.mounted_avail_space.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.processes_stats = new ArrayList<ProcessStatus>(_list11.size);
          ProcessStatus _elem12;
          for (int _i13 = 0; _i13 < _list11.size; ++_i13)
          {
            _elem12 = new ProcessStatus();
            _elem12.read(iprot);
            struct.processes_stats.add(_elem12);
          }
        }
        struct.setProcesses_statsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.mounted_avail_space = new HashMap<String,Long>(2*_map14.size);
          String _key15;
          long _val16;
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            ...
            struct.mounted_avail_space.put(_key15, _val16);
          }
        }
        struct.setMounted_avail_spaceIsSet(true);
      }
