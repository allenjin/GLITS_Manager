...
public class HeartbeatResponse implements org.apache.thrift.TBase<HeartbeatResponse, HeartbeatResponse._Fields>, java.io.Serializable, Cloneable, Comparable<HeartbeatResponse> {
  ...
  private static final org.apache.thrift.protocol.TField HEARTBEAT_INTERVAL_FIELD_DESC = new org.apache.thrift.protocol.TField("heartbeat_interval", org.apache.thrift.protocol.TType.I64, (short)2);
  ...
  private static final org.apache.thrift.protocol.TField EXTRA_CONFIGS_FIELD_DESC = new org.apache.thrift.protocol.TField("extra_configs", org.apache.thrift.protocol.TType.MAP, (short)4);
  ...
  public long heartbeat_interval; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXTRA_CONFIGS((short)4, "extra_configs");
  ...
  public HeartbeatResponse setHeartbeat_interval(long heartbeat_interval) {
    this.heartbeat_interval = heartbeat_interval;
    setHeartbeat_intervalIsSet(true);
    return this;
  }
  ...
  public HeartbeatResponse setProcesses(Map<String,String> processes) {
    this.processes = processes;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case HEARTBEAT_INTERVAL:
      if (value == null) {
        ...
        setHeartbeat_interval((Long)value);
      }
      break;
  ...
  private static class HeartbeatResponseStandardScheme extends StandardScheme<HeartbeatResponse> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // HEARTBEAT_INTERVAL
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.heartbeat_interval = iprot.readI64();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.processes = new HashMap<String,String>(2*_map20.size);
                String _key21;
                String _val22;
                for (int _i23 = 0; _i23 < _map20.size; ++_i23)
                {
                  ...
                  struct.processes.put(_key21, _val22);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extra_configs = new HashMap<String,String>(2*_map24.size);
                String _key25;
                String _val26;
                for (int _i27 = 0; _i27 < _map24.size; ++_i27)
                {
                  ...
                  struct.extra_configs.put(_key25, _val26);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HeartbeatResponse struct) throws TException {
      ...
      oprot.writeI64(struct.heartbeat_interval);
      oprot.writeFieldEnd();
      if (struct.processes != null) {
        oprot.writeFieldBegin(PROCESSES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter28 : struct.processes.entrySet())
          {
      ...
      if (struct.extra_configs != null) {
        oprot.writeFieldBegin(EXTRA_CONFIGS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter29 : struct.extra_configs.entrySet())
          {
      ...
      if (struct.isSetProcesses()) {
        {
          ...
          for (Map.Entry<String, String> _iter30 : struct.processes.entrySet())
          {
      ...
      if (struct.isSetExtra_configs()) {
        {
          ...
          for (Map.Entry<String, String> _iter31 : struct.extra_configs.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.processes = new HashMap<String,String>(2*_map32.size);
          String _key33;
          String _val34;
          for (int _i35 = 0; _i35 < _map32.size; ++_i35)
          {
            ...
            struct.processes.put(_key33, _val34);
          }
        }
        struct.setProcessesIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.extra_configs = new HashMap<String,String>(2*_map36.size);
          String _key37;
          String _val38;
          for (int _i39 = 0; _i39 < _map36.size; ++_i39)
          {
            ...
            struct.extra_configs.put(_key37, _val38);
          }
        }
        struct.setExtra_configsIsSet(true);
      }
