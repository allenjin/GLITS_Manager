            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processes = new ArrayList<Process>(_list28.size);
                Process _elem29;
                for (int _i30 = 0; _i30 < _list28.size; ++_i30)
                {
                  _elem29 = new Process();
                  _elem29.read(iprot);
                  struct.processes.add(_elem29);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extra_configs = new HashMap<String,String>(2*_map31.size);
                String _key32;
                String _val33;
                for (int _i34 = 0; _i34 < _map31.size; ++_i34)
                {
                  ...
                  struct.extra_configs.put(_key32, _val33);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HeartbeatResponse struct) throws TException {
      ...
      if (struct.processes != null) {
        oprot.writeFieldBegin(PROCESSES_FIELD_DESC);
        {
          ...
          for (Process _iter35 : struct.processes)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.extra_configs != null) {
        oprot.writeFieldBegin(EXTRA_CONFIGS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter36 : struct.extra_configs.entrySet())
          {
      ...
      if (struct.isSetProcesses()) {
        {
          ...
          for (Process _iter37 : struct.processes)
          {
            _iter37.write(oprot);
          }
        }
      ...
      if (struct.isSetExtra_configs()) {
        {
          ...
          for (Map.Entry<String, String> _iter38 : struct.extra_configs.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.processes = new ArrayList<Process>(_list39.size);
          Process _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new Process();
            _elem40.read(iprot);
            struct.processes.add(_elem40);
          }
        }
        struct.setProcessesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.extra_configs = new HashMap<String,String>(2*_map42.size);
          String _key43;
          String _val44;
          for (int _i45 = 0; _i45 < _map42.size; ++_i45)
          {
            ...
            struct.extra_configs.put(_key43, _val44);
          }
        }
        struct.setExtra_configsIsSet(true);
      }
